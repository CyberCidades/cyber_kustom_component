 ...
 */
public class PanelPaletteColor extends javax.swing.JPanel {

    /**
     * Creates new form NewJPanel
     */
    
     public MouseListener taskPerformer = new MouseAdapter() {
        
        @Override
        public void mouseClicked(MouseEvent me) {
            Color cor = me.getComponent().getBackground();
            copy(cor.getRed()+", "+cor.getGreen()+", "+cor.getBlue());
            AssistentPaletteColor.jPColorSelecionada.setBackground(cor);
        }
    };
     
    public PanelPaletteColor() {

        initComponents();
        
        addActionListenerToAll(jPanel1, taskPerformer);
    }
    
    /*
        @fontes http://www.guj.com.br/t/botao-q-copia-o-conteudo-de-um-visor-no-ctrl-c/72464/5
    */
    public void copy (String cor) {
        Clipboard clipBoard = getToolkit().getSystemClipboard();
        StringSelection ss = new StringSelection(cor);
        clipBoard.setContents(ss,ss);
    }
    
    /*
       fontes https://stackoverflow.com/a/16368729
    */
    public static void addActionListenerToAll( Component parent, MouseListener listener ) {
        // add this component

        // TODO, other components as needed
        if( parent instanceof JPanel ) {
            ((JPanel)parent).addMouseListener( listener );
        }
...
//        }
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(95, 0, 70));
        ...
        jPanel3.setBackground(new java.awt.Color(153, 0, 61));
        ...
        jPanel4.setBackground(new java.awt.Color(211, 0, 50));
        ...
        jPanel5.setBackground(new java.awt.Color(255, 64, 30));
        ...
        jPanel6.setBackground(new java.awt.Color(254, 205, 0));
        ...
        jPanel7.setBackground(new java.awt.Color(39, 54, 59));
        ...
        jPanel8.setBackground(new java.awt.Color(235, 73, 96));
        ...
        jPanel9.setBackground(new java.awt.Color(244, 131, 125));
        ...
        jPanel10.setBackground(new java.awt.Color(253, 206, 170));
        ...
        jPanel11.setBackground(new java.awt.Color(153, 185, 152));
        ...
        jPanel12.setBackground(new java.awt.Color(50, 206, 180));
        ...
        jPanel13.setBackground(new java.awt.Color(255, 238, 173));
        ...
        jPanel14.setBackground(new java.awt.Color(255, 111, 105));
        ...
        jPanel15.setBackground(new java.awt.Color(255, 204, 92));
        ...
        jPanel16.setBackground(new java.awt.Color(136, 216, 176));
        ...
        jPanel17.setBackground(new java.awt.Color(1, 31, 75));
        ...
        jPanel18.setBackground(new java.awt.Color(3, 57, 108));
        ...
        jPanel19.setBackground(new java.awt.Color(0, 91, 150));
        ...
        jPanel20.setBackground(new java.awt.Color(100, 151, 177));
        ...
        jPanel22.setBackground(new java.awt.Color(191, 44, 35));
        ...
        jPanel23.setBackground(new java.awt.Color(223, 168, 71));
        ...
        jPanel24.setBackground(new java.awt.Color(186, 169, 120));
        ...
        jPanel25.setBackground(new java.awt.Color(155, 154, 116));
        ...
        jPanel26.setBackground(new java.awt.Color(45, 81, 89));
        ...
        jPanel27.setBackground(new java.awt.Color(118, 90, 116));
        ...
        jPanel29.setBackground(new java.awt.Color(163, 97, 120));
        ...
        jPanel30.setBackground(new java.awt.Color(195, 102, 121));
        ...
        jPanel31.setBackground(new java.awt.Color(226, 171, 199));
        ...
        jPanel32.setBackground(new java.awt.Color(226, 204, 213));
        ...
        jPanel34.setBackground(new java.awt.Color(116, 159, 237));
        ...
        jPanel35.setBackground(new java.awt.Color(36, 47, 56));
        ...
        jPanel36.setBackground(new java.awt.Color(51, 67, 80));
        ...
        jPanel37.setBackground(new java.awt.Color(38, 193, 93));
        ...
        jPanel38.setBackground(new java.awt.Color(238, 105, 82));
